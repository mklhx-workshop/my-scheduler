 ...
 */
final class Version20181126195655 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE car_planning (id INT AUTO_INCREMENT NOT NULL, cars_id INT DEFAULT NULL, date_start DATETIME NOT NULL, am_pm_start VARCHAR(255) NOT NULL, date_end DATETIME NOT NULL, am_pm_end VARCHAR(255) NOT NULL, customer VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, user INT NOT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_5BAF8AF28702F506 (cars_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, company VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, role LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', password VARCHAR(255) NOT NULL, initials VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
