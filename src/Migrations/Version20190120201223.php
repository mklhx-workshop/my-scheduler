...
final class Version20190120201223 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, thing_id INT DEFAULT NULL, calendar_id INT DEFAULT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, comment LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_E00CEDDEC36906A7 (thing_id), INDEX IDX_E00CEDDEA40A2C8 (calendar_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_E00CEDDEC36906A7 FOREIGN KEY (thing_id) REFERENCES thing (id)');
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_E00CEDDEA40A2C8 FOREIGN KEY (calendar_id) REFERENCES calendar (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event DROP FOREIGN KEY FK_E00CEDDEA40A2C8');
        $this->addSql('ALTER TABLE event DROP FOREIGN KEY FK_E00CEDDEC36906A7');
